...
| `spec/fixtures/cross_sdk/cross-sdk-bucketing-vectors.json` | `javascript-sdk` | `packages/bucketing/tests/cross-sdk-bucketing-vectors.json` | `c4b2b8e23fed84e0b7bcd1cb7b78613cca294b39` | 2026-07-04 | `9993d0e6c5719cb17a4dcbcc73af9c0cb14ee0258e7fd29cc88f44b61083dd1b` |
...
- `cross-sdk-bucketing-vectors.json` (59 bucketing vectors, versions {11,12}) — the canonical cross-SDK golden fixture for the anchored bucketing layout (contract v12); consumed by the anchored bucketing parity spec (qs-01). Its expected values ARE the cross-SDK contract — a failing vector means a bug in this port, not the fixture.
